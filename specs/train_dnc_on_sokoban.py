...
SAVE_MODELS_TO = models/new_dnc_sokoban.pth
...
SOKOBAN_OBSERVATION_FORMAT = grid
...
AC_HIDDEN_LAYER_SIZE = 100


DNC_HIDDEN_SIZE = 64
DNC_MEMORY_SIZE = 16
DNC_WORD_SIZE = 16
DNC_NUM_WRITE_HEADS = 2
DNC_READ_HEADS = 4
#make sure this is changed to 1+2*DNC_NUM_WRITE_HEADS
#DNC_READ_MODES = 1+2*1
