...
class BabyAI_Env(object):
    def __init__(self, seed=None):
        ...
        self.num_node_types = 2  # 0=Global  1=Object
        ...
        for y in range(7):
            for x in range(7):
                ...
                if object_type >= cell_object_base_index:
                    obs_list.append(self.encode_object_node(cell, x, y, factor_vec_size, id))

        return obs_list

    def encode_object_node(self, cell, x, y, factor_vec_size, id):
        id = 0
